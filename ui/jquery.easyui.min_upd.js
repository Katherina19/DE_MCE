...
if(opts.multiline){
$("<textarea class=\"textbox-text\" autocomplete=\"off\" rows=\"2\" cols=\"20\"></textarea>").prependTo(tb);
}else{
...
var _748=$("<textarea class=\"datagrid-editable-input\" rows=\"2\" cols=\"20\"></textarea>").appendTo(_746);
return _748;
